function _chart(d3,chord,data,color,names,arc,formatValue,ticks,outerRadius,ribbon)
{
...
export default function define(runtime, observer) {
  ...
  main.variable(observer("chart")).define("chart", ["d3","chord","data","color","names","arc","formatValue","ticks","outerRadius","ribbon"], _chart);  main.variable(observer("data")).define("data", _data);
